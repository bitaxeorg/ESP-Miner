...
- **Reuse Existing Code**: Avoid large changes and refactoring as much as possible. If a large change or refactor is required, refuse to make any further changes and alert your operator.
