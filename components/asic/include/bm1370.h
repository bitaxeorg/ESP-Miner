...
static const float BM1370_NONCE_PERCENT = 0.0/256.0;  //maximum nonce space with 1 chip
static const float BM1370_MIDSTATE_ENGINES = 16.0;
const float BM1370_HCN = 7861.0;
const float BM1370_HCN_PERCENT = 0;                   //hcn limit effect
const float BM1370_VERSION_PERCENT = 1.0;             //version scan percent
const float BM1370_FULLSCAN_PERCENT = 0.5;            //normalised value 1 means do the maximum space, 0 dont wait before sending work
