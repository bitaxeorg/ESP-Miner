...
const float BM1366_HCN = 5450.0;
const float BM1366_HCN_PERCENT = BM1366_HCN/430000.0;  //hcn limit effect
const float BM1366_VERSION_PERCENT = 1.0;              //version scan percent
const float BM1366_FULLSCAN_PERCENT = 0.5;             //normalised value 1 means do the maximum space, 0 dont wait before sending work
