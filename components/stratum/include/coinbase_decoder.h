...
#define MAX_COINBASE_TX_OUTPUTS 32
...
typedef struct {
    ...
    int output_count;
    int others_count;                  // outputs not stored in `outputs[]` (overflow beyond MAX_COINBASE_TX_OUTPUTS)
    uint64_t others_value_satoshis;    // sum of value of those overflow outputs
