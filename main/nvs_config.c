...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_STRATUM_SHARE_WARNING]                 = {.nvs_key_name = "stratumwarn",     .type = TYPE_BOOL,  .default_value = {.b   = true},                                        .rest_name = "stratumShareWarning",                .min = 0,  .max = 1},
    ...
    [NVS_CONFIG_FALLBACK_STRATUM_SHARE_WARNING]        = {.nvs_key_name = "fbstratumwarn",   .type = TYPE_BOOL,  .default_value = {.b   = true},                                        .rest_name = "fallbackStratumShareWarning",        .min = 0,  .max = 1},
