...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_AUTOTUNE_ENABLED]                      = {.nvs_key_name = "autotune_en",     .type = TYPE_BOOL,  .default_value = {.b   = false},                                       .rest_name = "autotuneEnabled",                    .min = 0,  .max = 1},
    [NVS_CONFIG_AUTOTUNE_PROFILE]                      = {.nvs_key_name = "autotune_prof",   .type = TYPE_U16,   .default_value = {.u16 = 1},                                           .rest_name = "autotuneProfile",                    .min = 0,  .max = 1},
    [NVS_CONFIG_AUTOTUNE_MAX_MHZ]                      = {.nvs_key_name = "autotune_maxmhz", .type = TYPE_FLOAT, .default_value = {.f   = 0},                                           .rest_name = "autotuneMaxMHz",                     .min = 0,  .max = 1500},
