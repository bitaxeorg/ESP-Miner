...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_CAROUSEL_SCREENS]                      = {.nvs_key_name = "caroussel",       .type = TYPE_U16,   .default_value = {.u16 = 15},                                          .rest_name = "carouselScreens",                    .min = 1,  .max = 15},
    [NVS_CONFIG_CAROUSEL_DELAY]                        = {.nvs_key_name = "carouseldly",     .type = TYPE_U16,   .default_value = {.u16 = 10},                                          .rest_name = "carouselDelay",                      .min = 1,  .max = 60},
