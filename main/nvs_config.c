...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_SV2_REQUIRE_AUTH]                      = {.nvs_key_name = "sv2reqauth",      .type = TYPE_BOOL,  .default_value = {.b   = false},                                       .rest_name = "stratumV2RequireAuth",               .min = 0,  .max = 1},
    ...
    [NVS_CONFIG_FALLBACK_SV2_REQUIRE_AUTH]             = {.nvs_key_name = "fbsv2reqauth",    .type = TYPE_BOOL,  .default_value = {.b   = false},                                       .rest_name = "fallbackStratumV2RequireAuth",       .min = 0,  .max = 1},
