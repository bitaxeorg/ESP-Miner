...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_GATEWAY_CLOUD_API_KEY]                 = {.nvs_key_name = "gw_cloud_key",   .type = TYPE_STR,   .default_value = {.str = ""},      .rest_name = "gatewayClientSecret",   .min = 0, .max = NVS_STR_LIMIT},
    ...
    [NVS_CONFIG_GATEWAY_CLIENT_ID]                     = {.nvs_key_name = "gw_client_id",   .type = TYPE_STR,   .default_value = {.str = ""},      .rest_name = "gatewayClientId",       .min = 0, .max = NVS_STR_LIMIT},
};
