...
typedef struct {
    ...
    int8_t internal_temp_offset;
    int8_t external_temp_offset;
    bool DS4432U : 1;
    bool INA260  : 1;
    bool TPS546  : 1;
    // test values
...
static const DeviceConfig default_configs[] = {
    { .board_version = "2.2",  .family = FAMILY_MAX,         .EMC2101 = true,                                                             .internal_temp_offset = 5, .external_temp_offset = 0,  .DS4432U = true, .INA260 = true, .plug_sense = true, .asic_enable = true, .power_consumption_target = 12, },
    { .board_version = "102",  .family = FAMILY_MAX,         .EMC2101 = true,                                                             .internal_temp_offset = 5, .external_temp_offset = 0,  .DS4432U = true, .INA260 = true, .plug_sense = true, .asic_enable = true, .power_consumption_target = 12, },
    { .board_version = "0.11", .family = FAMILY_ULTRA,       .EMC2101 = true, .emc_internal_temp = true,                                  .internal_temp_offset = 5, .external_temp_offset = 0,  .DS4432U = true, .INA260 = true, .plug_sense = true, .asic_enable = true, .power_consumption_target = 12, },
    { .board_version = "201",  .family = FAMILY_ULTRA,       .EMC2101 = true, .emc_internal_temp = true,                                  .internal_temp_offset = 5, .external_temp_offset = 0,  .DS4432U = true, .INA260 = true, .plug_sense = true, .asic_enable = true, .power_consumption_target = 12, },
    { .board_version = "202",  .family = FAMILY_ULTRA,       .EMC2101 = true, .emc_internal_temp = true,                                  .internal_temp_offset = 5, .external_temp_offset = 0,  .DS4432U = true, .INA260 = true, .plug_sense = true, .asic_enable = true, .power_consumption_target = 12, },
    { .board_version = "203",  .family = FAMILY_ULTRA,       .EMC2101 = true, .emc_internal_temp = true,                                  .internal_temp_offset = 5, .external_temp_offset = 0,  .DS4432U = true, .INA260 = true, .plug_sense = true, .asic_enable = true, .power_consumption_target = 12, },
    { .board_version = "204",  .family = FAMILY_ULTRA,       .EMC2101 = true, .emc_internal_temp = true,                                  .internal_temp_offset = 5, .external_temp_offset = 0,  .DS4432U = true, .INA260 = true, .plug_sense = true,                      .power_consumption_target = 12, },
    { .board_version = "205",  .family = FAMILY_ULTRA,       .EMC2101 = true, .emc_internal_temp = true,                                  .internal_temp_offset = 5, .external_temp_offset = 0,  .DS4432U = true, .INA260 = true, .plug_sense = true, .asic_enable = true, .power_consumption_target = 12, },
    { .board_version = "400",  .family = FAMILY_SUPRA,       .EMC2101 = true, .emc_internal_temp = true,                                  .internal_temp_offset = 5, .external_temp_offset = 0,  .DS4432U = true, .INA260 = true, .plug_sense = true, .asic_enable = true, .power_consumption_target = 12, },
    { .board_version = "401",  .family = FAMILY_SUPRA,       .EMC2101 = true, .emc_internal_temp = true,                                  .internal_temp_offset = 5, .external_temp_offset = 0,  .DS4432U = true, .INA260 = true, .plug_sense = true, .asic_enable = true, .power_consumption_target = 12, },
    { .board_version = "402",  .family = FAMILY_SUPRA,       .EMC2101 = true,                                                             .internal_temp_offset = 5, .external_temp_offset = 0,  .TPS546 = true,                                                           .power_consumption_target = 5,  },
    { .board_version = "403",  .family = FAMILY_SUPRA,       .EMC2101 = true,                                                             .internal_temp_offset = 5, .external_temp_offset = 0,  .TPS546 = true,                                                           .power_consumption_target = 5,  },
    { .board_version = "600",  .family = FAMILY_GAMMA,       .EMC2101 = true, .emc_ideality_factor = 0x24, .emc_beta_compensation = 0x00, .internal_temp_offset = 5, .external_temp_offset = 0,  .TPS546 = true,                                                           .power_consumption_target = 19, },
    { .board_version = "601",  .family = FAMILY_GAMMA,       .EMC2101 = true, .emc_ideality_factor = 0x24, .emc_beta_compensation = 0x00, .internal_temp_offset = 5, .external_temp_offset = 0,  .TPS546 = true,                                                           .power_consumption_target = 19, },
    { .board_version = "602",  .family = FAMILY_GAMMA,       .EMC2101 = true, .emc_ideality_factor = 0x24, .emc_beta_compensation = 0x00, .internal_temp_offset = 5, .external_temp_offset = 0,  .TPS546 = true,                                                           .power_consumption_target = 22, },
    { .board_version = "800",  .family = FAMILY_GAMMA_TURBO, .EMC2103 = true,                                                             .internal_temp_offset = 5, .external_temp_offset = -10, .TPS546 = true,                                                           .power_consumption_target = 12, },
};
