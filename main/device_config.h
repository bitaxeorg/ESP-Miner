...
static const uint16_t BM1340_FREQUENCY_OPTIONS[]   = {350, 375, 380, 400, 410,                          0};
...
static const uint16_t BM1340_VOLTAGE_OPTIONS[] = {1000, 1060, 1100, 1150, 1200, 1250,                   0};
...
static const AsicConfig ASIC_BM1340 = { .id = BM1340, .name = "BM1340", .chip_id = 1340, .default_frequency_mhz = 345, .frequency_options = BM1340_FREQUENCY_OPTIONS, .default_voltage_mv = 1000, .voltage_options = BM1340_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 128, .small_core_count = 6725, .hash_domains = 4, .hashrate_test_percentage_target = 0.85, .default_asic_timeout = 500};
...
static const FamilyConfig FAMILY_NAJA        = { .id = NAJA,        .name = "Naja",       .asic = ASIC_BM1340,   .asic_count = 2, .max_power = 60,  .power_offset = 10, .nominal_voltage = 12, .voltage_domains = 1, .swarm_color = "magenta",  };
...
static const DeviceConfig default_configs[] = {
    ...
    { .board_version = "1200", .family = FAMILY_NAJA,        .EMC2103 = true,                                                             .temp_offset = 10,  .TPS546 = true,                                                           .power_consumption_target = 12, },
