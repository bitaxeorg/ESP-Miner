...
static const DeviceConfig default_configs[] = {
    ...
    { .board_version = 602, .family = FAMILY_GAMMA,       .display = SSD1306, .thermal = EMC2101_EXTERNAL, .emc2101_config = EMC2101_CONFIG_GAMMA, .TPS546 = true, },
    { .board_version = 800, .family = FAMILY_GAMMA_TURBO, .display = SSD1306, .thermal = EMC2103,                                                  .TPS546 = true, },
};
