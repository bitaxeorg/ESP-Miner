...
static const uint16_t BM1340_FREQUENCY_OPTIONS[] = {400, 490, 525, 550, 600, 625,                     0};
...
static const AsicConfig ASIC_BM1340 = { .id = BM1340, .name = "BM1340", .chip_id = 1340, .default_frequency_mhz = 345, .frequency_options = BM1340_FREQUENCY_OPTIONS, .default_voltage_mv = 1000, .voltage_options = BM1340_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 128, .small_core_count = 6725, .hashrate_test_percentage_target = 0.85, };
...
static const DeviceConfig default_configs[] = {
    ...
    { .board_version = "1200", .family = FAMILY_NAJA,        .EMC2103 = true,                                                             .emc_temp_offset = -10, .TPS546 = true,                                                           .power_consumption_target = 12, },
};
