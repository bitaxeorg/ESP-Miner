...
static const uint16_t BM1368_FREQUENCY_OPTIONS[] = {400, 425, 450, 475, 485, 500, 525, 550, 575,      0};
...
static const uint16_t BM1368_VOLTAGE_OPTIONS[] = {1100, 1150, 1200, 1250, 1300,                         0};
...
static const AsicConfig ASIC_BM1366 = { .model = BM1366, .name = "BM1366", .chip_id = 1366, .default_frequency_mhz = 486, .frequency_options = BM1366_FREQUENCY_OPTIONS, .default_voltage_mv = 1200, .voltage_options = BM1366_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 112, .small_core_count =  894, .hashrate_test_percentage_target = 0.85, };
