...
static const char *screen_local_work_rpc_display(void)
{
...
static void screen_update_cb(lv_timer_t * timer)
{
    ...
    const char *pool_url = nvs_config_get_bool(NVS_CONFIG_LOCAL_WORK_ENABLED)
                               ? screen_local_work_rpc_display()
