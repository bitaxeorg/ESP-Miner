...
void SYSTEM_init_system(GlobalState * GLOBAL_STATE)
{
    ...
    // Initialize GridPool direct status. The polling task refreshes these when enabled.
    ...
    snprintf(module->gridpool_status, sizeof(module->gridpool_status), "%s",
             nvs_config_get_bool(NVS_CONFIG_GRIDPOOL_ENABLED) ? "Not checked" : "Disabled");
    strcpy(module->gridpool_last_error, "");
