    ...
    return of(
      {
        ...
        localWorkEnabled: 0 as const,
        localWorkBitcoinRpcUrl: "http://192.168.1.10:8332",
        localWorkBitcoinRpcAuthMode: "basic" as const,
        localWorkBitcoinRpcUsername: "bitcoinrpc",
        localWorkPayoutAddress: "bc1q99n3pu025yyu0jlywpmwzalyhm36tg5u37w20d",
        localWorkFallbackToStratum: 1 as const,
        localWorkTemplateReachable: 0 as const,
        localWorkTemplateStatus: "Disabled",
        localWorkTemplateLastError: "",
        localWorkTemplateRuns: 0,
        localWorkTemplateFailures: 0,
        localWorkTemplateHeight: 0,
        localWorkTemplateTxCount: 0,
        localWorkTemplateBytes: 0,
        localWorkTemplateRpcMs: 0,
        localWorkTemplateParseMs: 0,
        localWorkTemplateBuildMs: 0,
        localWorkTemplateTotalMs: 0,
        localWorkTemplateHeapAfter: 200504,
        localWorkDirectJobsSent: 0,
        localWorkBlockSubmits: 0,
        localWorkBlockAccepted: 0,
        localWorkBlockRejected: 0,
        localWorkBlockStatus: "",
