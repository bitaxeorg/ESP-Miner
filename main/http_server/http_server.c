...
bool check_settings_and_update(const cJSON * const root, bool update)
{
    ...
    const SettingsFormat settings_format[] = {
        ...
        { .name = "stratumExtranonceSubscribe",         .json_type = cJSON_Option, .nvs_type = NVS_TYPE_U16, .nvs_name = NVS_CONFIG_STRATUM_EXTRANONCE_SUBSCRIBE },
        { .name = "stratumSuggestedDifficulty",         .json_type = cJSON_Number, .nvs_type = NVS_TYPE_U16, .nvs_name = NVS_CONFIG_STRATUM_DIFFICULTY },
        ...
        { .name = "fallbackStratumExtranonceSubscribe", .json_type = cJSON_Option, .nvs_type = NVS_TYPE_U16, .nvs_name = NVS_CONFIG_FALLBACK_STRATUM_EXTRANONCE_SUBSCRIBE },
        { .name = "fallbackStratumSuggestedDifficulty", .json_type = cJSON_Number, .nvs_type = NVS_TYPE_U16, .nvs_name = NVS_CONFIG_FALLBACK_STRATUM_DIFFICULTY },
        ...
        { .name = "minFanSpeed",                        .json_type = cJSON_Number, .nvs_type = NVS_TYPE_U16, .nvs_name = NVS_CONFIG_MIN_FAN_SPEED },
