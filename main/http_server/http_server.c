...
/* Handler for system status endpoint, live */
...
static esp_err_t GET_system_config(httpd_req_t *req)
{
    ...
    cJSON_AddBoolToObject(root, "flipScreen", nvs_config_get_u16(NVS_CONFIG_FLIP_SCREEN, 1));
...
esp_err_t start_rest_server(void * pvParameters)
{
    ...
    httpd_uri_t system_statistics_dashboard_get_uri = {
        .uri = "/api/v2/system/statistics/dashboard", 
        .method = HTTP_GET, 
