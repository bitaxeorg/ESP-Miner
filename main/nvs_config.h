...
typedef enum {
    ...
    NVS_CONFIG_LOCAL_WORK_ENABLED,
    NVS_CONFIG_LOCAL_WORK_BITCOIN_RPC_URL,
    NVS_CONFIG_LOCAL_WORK_BITCOIN_RPC_AUTH_MODE,
    NVS_CONFIG_LOCAL_WORK_BITCOIN_RPC_USERNAME,
    NVS_CONFIG_LOCAL_WORK_BITCOIN_RPC_PASSWORD,
    NVS_CONFIG_LOCAL_WORK_PAYOUT_ADDRESS,
    NVS_CONFIG_LOCAL_WORK_FALLBACK_TO_STRATUM,
    NVS_CONFIG_COUNT
} NvsConfigKey;
