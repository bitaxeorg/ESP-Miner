...
typedef enum {
    ...
    NVS_CONFIG_GRIDPOOL_ENABLED,
    NVS_CONFIG_GRIDPOOL_BOOT_URL,
    NVS_CONFIG_GRIDPOOL_BITCOIN_RPC_URL,
    NVS_CONFIG_GRIDPOOL_BITCOIN_RPC_AUTH_MODE,
    NVS_CONFIG_GRIDPOOL_BITCOIN_RPC_USERNAME,
    NVS_CONFIG_GRIDPOOL_BITCOIN_RPC_PASSWORD,
    NVS_CONFIG_GRIDPOOL_PAYOUT_ADDRESS,
    NVS_CONFIG_GRIDPOOL_MIN_SUBMIT_DIFFICULTY,
    NVS_CONFIG_GRIDPOOL_REWARD_MODE,
    NVS_CONFIG_GRIDPOOL_FALLBACK_TO_STRATUM,
    NVS_CONFIG_COUNT
} NvsConfigKey;
