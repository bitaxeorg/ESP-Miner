...
typedef enum {
    ...
    // Gateway settings
    NVS_CONFIG_GATEWAY_ENABLED,
    NVS_CONFIG_GATEWAY_PEERS,
    NVS_CONFIG_GATEWAY_POLL_INTERVAL,
    NVS_CONFIG_GATEWAY_CLOUD_URL,
    NVS_CONFIG_GATEWAY_CLOUD_API_KEY,
    NVS_CONFIG_GATEWAY_CLOUD_ENABLED,
    NVS_CONFIG_GATEWAY_CLIENT_ID,
